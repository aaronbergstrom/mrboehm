            ...
            for defBus in template["defaults"]:
                ...
                for chip in defBus["chips"]:
                    if chip["type"] == "DAC":
                        ...
                        #GPIO chip
                        gpioc = chip["addr"]
                        bus.write_i2c_block_data(gpioc, 0x06, [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00])
                        bus.write_i2c_block_data(gpioc, 0x07, [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00])
